...
- `.tracerkit/` files (PRDs, plans) are safe to commit in this repo — it dogfoods its own workflow. Always stage, commit, and push `.tracerkit/` changes alongside implementation.
