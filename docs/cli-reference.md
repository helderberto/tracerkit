...
| `tracerkit config [path]`               | Print current configuration                           |
| `tracerkit config [path] <key>`         | Print a specific config value                         |
| `tracerkit config [path] <key> <value>` | Set a config value and re-render skills               |
...
$ tracerkit config . storage github     # switch project install to GitHub storage
