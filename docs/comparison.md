...
| ---------------- | ---------------- | -------------------------- | ----------------------- | ----------------------------------- |
| **What it is**   | CLI + extensions | Agentic IDE (VS Code fork) | Slash-command framework | Markdown skills + CLI               |
...
| **Runtime deps** | Python + uv      | Proprietary IDE            | None                    | Node.js (via npx)                   |
